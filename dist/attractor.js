...
export class Attractor {
    constructor(x, y, svg, attractorColor, backgroundColor, loadingColor) {
        this.x = x;
        this.y = y;
        this.shapeMatrix = [];
        this.matrixWidth = 0;
        this.matrixHeight = 0;
        this.matrixHalfWidth = 0;
        this.matrixHalfHeight = 0;
        this.nearestX = null;
        this.nearestY = null;
        this.debugImage = null;
        this.nearestCollisionPoints = new Map();
        this.force = 2;
    ...
    createShapeMatrix(svg) {
        ...
        img.onload = () => {
            ...
            console.log(`Has true values: ${trueCount} out of ${totalPixels} pixels (${((trueCount / totalPixels) *
                100).toFixed(2)}%)`);
    ...
    computeNearestNeighborField(width, height) {
    ...
    findNearestCollisionPoint(particle) {
        if (!this.nearestX || !this.nearestY)
            return null;
